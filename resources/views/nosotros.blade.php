...
<head>
    ...
    <link href="{{ asset('css/noso.css') }}" rel="stylesheet">
</head>
        ...
        <div class="velo-negro">
            ...
            <header class="header">
                <a href="/welcome">
                    ...
                    <img src="/IMG/Weirdo Comics.jpg" alt="logo" class="logo-img">
                </a>
            ...
            <main class="contenedor">
                ...
                <div class="nosotros">
                    <img class="nosotros-img" src="/IMG/bats.jpg" alt="nosotros">



                    <div class="nosotros-texto">
                        <p><font color="white"> Estas librerías especializadas presentan una serie de características que las distinguen de las 
                            librerías generalistas: Tiene más variedad de historietas que una librería generalista, debido a su 
                            carácter especializado. ​ Suelen ordenar su material por editoriales o colecciones, en vez de por 
                            géneros.</font></p>
                        <p><font color="white"> Dos de las primeras librerías especializadas del mundo aparecieron a finales de los años sesenta:
                             La holandesa Lambiek, fundada por Kees Kousemaker en 1968, y la londinense Dark They Were, and 
                             Golden-Eyed </font></p>
            ...
            <section class="contenedor">
                <div class="bloques">
                    <div class="bloque">
                        <!--IMG-->
                        <img src="/IMG/proteger.png" alt="SEGURIDAD">
                        <h3 class="bloque-titulo"><font color="white">Protección</font></h3>
                        <p><font color="white">En nuestra sección de avisos te facilitamos toda la información necesaria para prevenir, 
                            proteger y responder ante incidentes de seguridad en el entorno</font></p>
                    ...
                    <div class="bloque">
                        ...
                        <h3 class="bloque-titulo"><font color="white">Protección</font></h3>
                        <p>Protegeremos con cuidado los productos enviados a su domicilio, con el mayor cuidado manejamos
                            los productos para que lleguen en perfecto estado</p>
