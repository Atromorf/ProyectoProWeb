...
<body>
    ...
    <div class="collapse" id="navbarToggleExternalContent">
        <div class="bg-dark p-4">
          <h5 class="text-white h4"><font color="yellow">Weirdo Comics</font></h5>
          <span class="text-muted"><a href="/welcome"><img src="/IMG/quitar-usuario2.png"></a></span>
          <li class="nav-item">
            <a class="nav-link {{ request()->routeIs('Login')?'text-danger fw-bold':'' }}" aria-current="page" href="{{ route('Login') }}"><font color="white">Articulos</font></a>
          </li>
          <li class="nav-item">
            <a class="nav-link {{ request()->routeIs('Login')?'text-danger fw-bold':'' }}" aria-current="page" href="{{ route('Login') }}"><font color="white">Registrar Usuario</font></a>
          </li>
        </div>
      </div>
