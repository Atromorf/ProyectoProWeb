...
<!-- Modal -->
<div class="modal fade" id="ModalEliminarA{{$vistaso->idArticulo}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="ModalEliminarA{{$vistaso->idArticulo}}" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="POST" action="{{route('articulo.destroy',$vistaso->idArticulo)}}">
            @csrf
            @method('DELETE')
    
            <div class="mb-2 text-gray-600 dark:text-gray-400 text-sm" style="background-color:brown">
                <p class="text-white  fst-italic">{{$vistaso->tipo}}</p>
            </div>
